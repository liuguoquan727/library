...
public class MediaSelectFragment extends BaseFragment {
                ...
                if (data != null) {
                    ...
                    if (count > 0) {
                        ...
                        do {
                            ...
                            String mimeType =
                                data.getString(
                                    data.getColumnIndexOrThrow(IMAGE_PROJECTION[3]));
                            ...
                            Resource resource =
                                new Resource(
                                    path, name, 0, 0, size, dateTime, mimeType, false);
                            // 获取文件夹名称
                            ...
                            if (folderFile != null
                                ...
                                .getAbsolutePath()
                                .contains(
                                    "/chargerlink/")) { // 过滤掉/DIMC/chargerlink目录的图片（临时图片）
    ...
    public static Intent getImageFromCrop(
        Uri data, Uri out, int aspectX, int aspectY, int outputX, int outputY) {
    ...
    protected void initView(View parent) {
        ...
        mMediaSelectAdapter =
            new ImageGridAdapter(
                getActivity(), mResources, mSelectedResources, mIsShowCamera, mMode);
            ...
            new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    boolean hasPermission =
                        UIUtil.requestPermissions(
                            MediaSelectFragment.this,
                            getString(
                                R.string.image_pick_request_permission_desc, name),
                            11,
                            CAMERA);
                    if (hasPermission) {
                        showCameraAction();
    ...
    private void initListDirPopupWindow() {
        ...
        mListDirs.setOnItemClickListener(
            new AdapterView.OnItemClickListener() {
                @Override
                public void onItemClick(
                    AdapterView<?> parent, View view, int position, long id) {
                    try {
                        mHeaderIcon.setImageResource(
                            R.drawable.image_pick_ic_select_photo_drop_down);
                        if (position == 0) {
                            mHeaderTitle.setText("所有图片");
                        } else {
        ...
        mImageFolderBackground.setOnClickListener(
            new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    dismissMenu();
    ...
    private void updateUI() {
        ...
        mPreview.setTextColor(
            selectedCount != 0
                ? getResources().getColor(R.color.image_pick_main_color_normal)
        ...
        mPreview.setOnClickListener(
            new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent =
                        new Intent(
                            MediaSelectFragment.this.getContext(),
                            ContainerActivity.class);
                    intent.putExtra(
                        ContainerActivity.FRAGMENT_NAME, PreviewFragment.class.getName());
                    intent.putExtras(bundle);
