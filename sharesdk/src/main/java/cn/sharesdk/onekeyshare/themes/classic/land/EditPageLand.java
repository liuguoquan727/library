...
public class EditPageLand extends EditPage implements OnClickListener, TextWatcher, Runnable {
  ...
  public void onCreate() {
    ...
    LinearLayout.LayoutParams lp =
        new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, titleHeight);
  ...
  private void initBody(RelativeLayout rlBody, float ratio) {
    ...
    rlBody.addView(svContent,
        new RelativeLayout.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT));

    LinearLayout llContent = new LinearLayout(activity);
    llContent.setOrientation(LinearLayout.HORIZONTAL);
    svContent.addView(llContent,
        new ScrollView.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT));
  ...
  private void initBottom(LinearLayout llBottom, float ratio) {
    ...
    LinearLayout.LayoutParams lp =
        new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, bottomHeight);
