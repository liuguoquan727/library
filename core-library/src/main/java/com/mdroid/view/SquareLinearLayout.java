...
public class SquareLinearLayout extends LinearLayout {
  ...
  public SquareLinearLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.SquareLinearLayout);
    mRatio = a.getFloat(R.styleable.SquareLinearLayout_ratio, DEFAULT_RATIO);
    mOrientation = a.getInt(R.styleable.SquareLinearLayout_orientation, HORIZONTAL);
    a.recycle();
  }
