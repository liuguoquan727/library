...
public class ValidationUtils {
  ...
  /**
   * 香港电话号码正则表达式= (^(5|6|9)\d{6,7}$)
   */
  public static final String HK_PHONE = "^(5|6|9)\\d{6,7}$";
  /**
   * 台湾电话号码正则表达式= (^09\d{8}$)
   */
  public static final String TAIWAN_PHONE = "^09\\d{8}$";
  /**
   * 手机号码正则表达式=^(13[0-9]|15[0-9]|17[0-9]|18[0-9])\d{8}$
   */
  public static final String MOBILE = "^(13[0-9]|14[0-9]|15[0-9]|16[0-9]|17[0-9]|18[0-9])\\d{8}$";
  ...
  /**
   * 判断是否为香港澳门手机号码 符合返回ture
   *
   * @return boolean
   */
  public static boolean isHKmobile(String str) {
    return Regular(str, HK_PHONE);
  }
   ...
   * @return boolean
   */
  public static boolean isTWmobile(String str) {
    return Regular(str, TAIWAN_PHONE);
  }
