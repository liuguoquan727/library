...
/**
 * You can also refer to {@link me.yokeyword.fragmentation_swipeback.SwipeBackFragment} to implement
 * YourSwipeBackFragment
...
public class SwipeBackFragment extends SupportFragment implements ISwipeBackFragment {
  ...
  @Override public View attachToSwipeBack(View view) {
