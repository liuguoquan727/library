 ...
 */
public abstract class SupportActivity<V extends AppBaseView, T extends AppBaseActivityPresenter<V>>
    extends AppBaseActivity<V, T> implements ISupportActivity {
  ...
  /**
   * It is recommended to use {@link SupportFragment#startWithPopTo(ISupportFragment, Class, *
   * boolean)}.
   *
